...
#perl parameterScan.pl -m /Users/ewiggin/Dropbox/Proyectos/CC3D_models/scripts/simple_model2 -s /Users/ewiggin/CC3D_3.7.5/ -p ParametersToScan.txt -c AdhAA,AdhAB:AdhAA,probability -n 3
# -m  --model
# -s  --software
# -p  --toScan
# -c  --combinations
